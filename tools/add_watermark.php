...
// Handle PDF upload and watermarking
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['pdfFile'])) {
    ...
    try {
        ...
        $pdf->SetCreator('PDF Watermark Tool');
        $pdf->SetAuthor('User');
        $pdf->SetTitle('Watermarked PDF');
        
        // Get watermark text from POST or use default
        $watermarkText = isset($_POST['watermarkText']) && !empty($_POST['watermarkText']) 
            ? $_POST['watermarkText'] 
            : 'CONFIDENTIAL';
...
<head>
    ...
    <title>Add Watermark to PDF | WeLovePDF</title>
    <!-- Tailwind CSS -->
            ...
            <div class="px-4 py-6">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="../tools/add-watermark.php" class="block px-3 py-2 rounded-lg bg-blue-50 text-blue-600 transition"><i class="fas fa-tint text-blue-500 mr-2"></i> Add Watermark</a></li>
                        <li><a href="../tools/add-number.php" class="block px-3 py-2 rounded-lg hover:bg-blue-50 transition"><i class="fas fa-sort-numeric-up text-blue-500 mr-2"></i> Add Page Numbers</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-3xl md:text-4xl font-bold mb-6 text-center">
                    Add <span class="gradient-text">Watermark to PDF</span>
                </h1>
                <p class="text-lg text-gray-600 mb-8 text-center">
                    Upload your PDF document and we'll add a custom watermark to each page.
                </p>
                    ...
                    <form id="converterForm" method="post" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="watermarkText" name="watermarkText" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Enter watermark text" value="CONFIDENTIAL">
                            </div>
                            
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="fontSize" class="block text-sm font-medium text-gray-700 mb-1">Font Size</label>
                                    <select id="fontSize" name="fontSize" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <select id="opacity" name="opacity" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                        <option value="0.2">Light</option>
                                        <option value="0.3" selected>Medium</option>
                                        <option value="0.4">Dark</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <button id="convertBtn" type="submit" 
                                ...
                                disabled>
                            <i class="fas fa-file-pdf mr-2"></i> Add Watermark & Download
                        </button>
                    </form>
                </div>
            </div>
